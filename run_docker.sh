...
docker run \
    ...
    -v ./mediapipe_extractor/data_samples:/root/ros_ws/src/mediapipe_extractor/data_samples:ro \
    -v ./mediapipe_extractor/scripts:/root/ros_ws/src/mediapipe_extractor/scripts:rw \
